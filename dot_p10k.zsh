# Generated by Powerlevel10k configuration wizard on 2025-03-09 at 10:33 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # azure                   # azure account name (https://docs.microsoft.com/en-us/cli/azure) gcloud                  # google cloud cli account and project (https://cloud.google.com/)
